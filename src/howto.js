...
var HowTo = CreateClass({
    render: function(){
        return (
            <div className="howTo">
                <h2 className="heading">元カレ計算機とは</h2>
                <p className="sentence">入力された情報を元に、<span className="enhance">「どのような武器編成が最大の火力を出せるか」</span>を総当たりで算出するツールです。</p>
                <p className="sentence">本計算機は「編成の比較をすること」がメインの計算機です。入力が面倒だし特定の武器編成の攻撃力だけ見られればいい！という方は <a href="http://gbf.xzz.jp">グラブル装備シミュレータ</a> の方がオススメです。</p><br/>

                <h2 className="heading">簡単な使い方</h2>
                <p className="sentence">左サイドバーのジータタブより以下の4項目を入力します。</p>
                <Thumbnail src="./otherImages/easy_1.png"></Thumbnail>
                <p className="sentence">召喚石タブより自石、サポ石の加護効果を入力します。</p>
                <Thumbnail src="./otherImages/easy_2.png"></Thumbnail>
                <p className="sentence">キャラタブよりフロントキャラ3人を入力します。</p>
                <Thumbnail src="./otherImages/easy_3.png"></Thumbnail>
                <p className="sentence">武器タブより編成に入る可能性のある武器を全て入力します。</p>
                <p className="sentence">※メイン武器など確定で入る武器は武器タブより武器名を開いた中にある「最小本数」を入力して下さい。</p>
                <Thumbnail src="./otherImages/easy_4.png"></Thumbnail>
                <p className="sentence">中央に編成結果一覧が出ます。</p>
                <Thumbnail src="./otherImages/easy_5.png"></Thumbnail>
            
                <h2 className="heading">各項の説明</h2>
                <p>基本的に各項目を埋めていけば、それに従って結果が自動的に更新されます。(選択メニューは値を選択した時点、入力フォームは値を入力した後にフォーム外をクリックする等の操作を行った際に、新しい結果が算出されます。)</p>
                <p>以下、各項目について説明します。</p>

                <hr/>
                <h3 className="heading">入力 / Input タブ</h3>
                ...
                <hr/>
                <h3 className="heading">>召喚石 / Summon タブ</h3>
                ...
                <hr/>
                <h3 className="heading">キャラ / Chara タブ</h3>
                ...
                <hr/>
                <h3 className="heading">武器 / Weapon タブ</h3>
                ...
                <hr/>
                <h3 className="heading">保存・注記 / System タブ</h3>
                ...
                <hr/>
                <h3 className="heading">結果 / Result タブ</h3>
