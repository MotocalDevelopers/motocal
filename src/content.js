                    ...
                    <div className="smartphone-content">
                        <div className="Tab" id="inputTab">
                            <h2 style={{
                                "marginTop": "10px",
                                "marginBottom": "5px"
                            }}>{intl.translate("motocal", locale)}</h2>
                        ...
                        <div className="Tab hidden" id="summonTab">
                            <SummonList dataName={this.state.dataName} summonNum={this.state.summonNum}
                                        onChange={this.onChangeSummonData} locale={locale}
                            ...
                            <ButtonGroup className="addRemoveButtonGroup">
                                <Button className="addRemoveButton" bsStyle="primary"
                                        onClick={this.addSummonNum}>{intl.translate("追加", locale)}(現在{this.state.summonNum}組)</Button>
                                <Button className="addRemoveButton" bsStyle="danger"
                                        onClick={this.subSummonNum}>{intl.translate("削除", locale)}</Button>
                            </ButtonGroup>
                        </div>
                        <div className="Tab hidden" id="charaTab">
                            <CharaList dataName={this.state.dataName} onChange={this.onChangeCharaData}
                                       charaNum={this.state.charaNum} pleaseAddCharaNum={this.addCharaNum}
                                       locale={locale} dataForLoad={this.state.dataForLoad.chara}/>
                            <ButtonGroup className="addRemoveButtonGroup">
                                <Button className="addRemoveButton" bsStyle="primary"
                                        onClick={this.addCharaNum}>{intl.translate("追加", locale)}(現在{this.state.charaNum}人)</Button>
                                <Button className="addRemoveButton" bsStyle="danger"
                                        onClick={this.subCharaNum}>{intl.translate("削除", locale)}</Button>
                            </ButtonGroup>
                        </div>
                        <div className="Tab hidden" id="armTab">
                            ...
                            <ButtonGroup className="addRemoveButtonGroup">
                                ...
                                <Button className="addRemoveButton" bsStyle="danger"
                                        onClick={this.subArmNum}>{intl.translate("削除", locale)}</Button>
                            </ButtonGroup>
                        </div>
            ...
            return (
                <div className="root">
                    <div className="rootleft" id="rootleft2"
                         style={{height: this.state.rootleftHeight + "%", width: this.state.rootleftWidth + "%"}}>
                        ...
                        <div className="main-content">
                            <div className="Tab" id="inputTab">
                                <Profile dataName={this.state.dataName} onChange={this.onChangeProfileData}
                                         locale={this.state.locale} dataForLoad={this.state.dataForLoad.profile}/>
                            </div>
                            <div className="Tab hidden" id="summonTab">
                                <SummonList dataName={this.state.dataName} summonNum={this.state.summonNum}
                                            onChange={this.onChangeSummonData} locale={locale}
                                ...
                                <ButtonGroup className="addRemoveButtonGroup">
                                    <Button className="addRemoveButton" bsStyle="primary"
                                            onClick={this.addSummonNum}>{intl.translate("追加", locale)}</Button>
                                    <Button className="addRemoveButton" bsStyle="danger"
                                            onClick={this.subSummonNum}>{intl.translate("削除", locale)}</Button>
                                </ButtonGroup>
                            </div>
                            <div className="Tab hidden" id="charaTab">
                                ...
                                <ButtonGroup className="addRemoveButtonGroup">
                                    <Button className="addRemoveButton" bsStyle="primary"
                                            onClick={this.addCharaNum}>{intl.translate("追加", locale)}</Button>
                                    <Button className="addRemoveButton" bsStyle="danger"
                                            onClick={this.subCharaNum}>{intl.translate("削除", locale)}</Button>
                                </ButtonGroup>
                            </div>
    ...
    render: function () {
        ...
        return (
            <div className="dataControl">
                {intl.translate("データ名", locale)}: <FormControl size="10" type="text" value={this.state.dataName}
                                                               onChange={this.handleEvent.bind(this, "dataName")}/>
                {intl.translate("ブラウザデータリスト", locale)}
                <FormControl componentClass="select" size={10} value={this.state.selectedData}
                             onClick={this.handleOnClick.bind(this, "selectedData")}
                             onChange={this.handleEvent.bind(this, "selectedData")}> {datalist} </FormControl>
                ...
                */}
                ...
                <FormGroup>
                    ...
                    <FormControl componentClass="textarea" bsSize="large" value={this.state.rawData}
                                 onChange={this.handleEvent.bind(this, "rawData")}/>
                    <ButtonGroup>
                        <Button tye="submit" bsStyle="primary"
                                onClick={this.onSubmitSaveRawData}>{intl.translate("移行データ出力", locale)}</Button>
                        <Button tye="submit" bsStyle="primary"
...
var TwitterShareButton = CreateClass({
    ...
    render: function () {
        ...
        return (
            <div className="tweet">
                <Button bsStyle="primary" className="tweetButton"
                        onClick={this.getShortenUrl}>{intl.translate("サーバに保存", this.props.locale)}</Button>
