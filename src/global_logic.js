...
module.exports.calcBasedOneSummon = function (summonind, prof, buff, totals) {
    ...
    for (var key in totals) {
        ...
        // proccess enemy defense:
        var enemyDefense = 10.0;
        var enemyDefenseDebuff = 0.0;
        if (prof.perCharaEnemyDefense) {   
            enemyDefense = totals[key].enemyDefense;
            enemyDefenseDebuff = totals[key].enemyDefenseDebuff;
        } else {
        ...
        var damage = module.exports.calcDamage(summedAttack, totalSkillCoeff, criticalRatio, enemyDefense, enemyDefenseDebuff, additionalDamage, damageUP, damageLimit);

        // Use damage in case of no critical to correct skill expectation
        var damageWithoutCritical = module.exports.calcDamage(summedAttack, totalSkillCoeff, 1.0, enemyDefense, enemyDefenseDebuff, additionalDamage, damageUP, damageLimit);
        ...
        var ougiDamage = module.exports.calcOugiDamage(summedAttack, totalSkillCoeff, criticalRatio, enemyDefense, enemyDefenseDebuff, totals[key]["ougiRatio"], ougiDamageUP, damageUP, ougiDamageLimit);
        ...
        res[key] = {
            ...
            enemyDefenseDebuff: enemyDefenseDebuff,
        };
    }
        ...
        "Djeeta":
            {
                ...
                buffCount: 0,
                //debuffCount: 0,
                enemyDefense: prof.enemyDefense,
                enemyDefenseDebuff: prof.defenseDebuff,
            }
    };
    ...
    for (var i = 0; i < chara.length; i++) {
        if (chara[i].name != "") {
            ...
            totals[charakey] = {
                ...
                //buffCount: 0,
                //debuffCount: 0,
                enemyDefense: chara[i].enemyDefense,
                enemyDefenseDebuff: chara[i].defenseDebuff,
            };
        }
    }
        ...
        for (var j = 0; j < oneresult.length; j++) {
            ...
            for (var key in onedata) {
                ...
                for (var k = 0; k < 100; k++) {
                    ...
                    var newDamage = module.exports.calcDamage(summedAttack, newTotalSkillCoeff, onedata[key].criticalRatio, onedata[key].enemyDefense, onedata[key].enemyDefenseDebuff, onedata[key].skilldata.additionalDamage, onedata[key].skilldata.damageUP, onedata[key].skilldata.damageLimit)
                    var newOugiDamage = module.exports.calcOugiDamage(summedAttack, newTotalSkillCoeff, onedata[key].criticalRatio, onedata[key].enemyDefense, onedata[key].enemyDefenseDebuff, onedata[key].ougiRatio, onedata[key].skilldata.ougiDamageUP, onedata[key].skilldata.damageUP, onedata[key].skilldata.ougiDamageLimit)
                    var chainBurstSupplemental = 0;
            ...
            for (var j = 0; j < turndata.length; j++) {
                ...
                for (var key in onedata) {
                    if (turnBuff.buffs["全体バフ"][t - 1].turnType == "ougi" || turnBuff.buffs[key][t - 1].turnType == "ougi") {
                        ...
                        var newOugiDamage = module.exports.calcOugiDamage(onedata[key].displayAttack, onedata[key].totalSkillCoeff, onedata[key].criticalRatio, onedata[key].enemyDefense, onedata[key].enemyDefenseDebuff, prof.ougiRatio, onedata[key].skilldata.ougiDamageUP, onedata[key].skilldata.damageUP, onedata[key].skilldata.ougiDamageLimit);
                        ...
                        // Regular attack
                        var newDamage = module.exports.calcDamage(onedata[key].displayAttack, onedata[key].totalSkillCoeff, onedata[key].criticalRatio, onedata[key].enemyDefense, onedata[key].enemyDefenseDebuff, onedata[key].skilldata.additionalDamage, onedata[key].skilldata.damageUP, onedata[key].skilldata.damageLimit);
                        if (key == "Djeeta") {
