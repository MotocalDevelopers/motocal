...
module.exports.generateHaisuiData = function (res, arml, summon, prof, chara, storedCombinations, storedNames, displayRealHP, locale) {
    ...
    var minMaxArr = {
        ...
        "newCalcTotalDamage": {"max": 0, "min": 0},
    ...
    if (res.length > 1) {
        ...
        var AllNewCalcTotalDamage = [[(displayRealHP ? intl.translate("残りHP", locale) : intl.translate("残HP割合", locale))]];
    ...
    for (var s = 0; s < res.length; s++) {
        ...
        var NewCalcTotalDamage = [[(displayRealHP ? intl.translate("残りHP", locale) : intl.translate("残HP割合", locale))]];
        ...
        for (var j = 0; j < oneresult.length; j++) {
            ...
            NewCalcTotalDamage[0].push(title);
            ...
            if (res.length > 1) {
                ...
                AllNewCalcTotalDamage[0].push("[" + summonHeader + "] " + title);
                    ...
                    if (key == "Djeeta") {
                        ...
                        if (hp in alreadyUsedHP) {
                            ...
                            for (var subj = 0; subj < oneresult.length; subj++) {
                                ...
                                NewCalcTotalDamage[index].push(null);
                            ...
                            if (res.length > 1) {
                                ...
                                if (hp in allAlreadyUsedHP) {
                                    ...
                                    for (var subj = 0; subj < res.length * oneresult.length; subj++) {
                                        ...
                                        AllNewCalcTotalDamage[allindex].push(null);
            ...
            if (res.length > 1) {
                for (var k = 0; k <= 100; k++) {
                    ...
                    AllNewCalcTotalDamage[allindex][allj] = NewCalcTotalDamage[index][j + 1];
        ...
        data[summonHeader]["newCalcTotalDamage"] = NewCalcTotalDamage;
    ...
    if (res.length > 1) {
        ...
        data[matomete]["newCalcTotalDamage"] = AllNewCalcTotalDamage;
